...
(cond ((eq system-type 'windows-nt)
       ...
       (if (file-exists-p "~/.emacs.d/windows_specific.el")
...
(if (file-exists-p "~/.emacs.d/color.el")
    (load "color"))

;;============Set keyboard Shortcuts

(if (file-exists-p "~/.emacs.d/shortcuts.el")
    (load "shortcuts"))
...
(if (file-exists-p "~/.emacs.d/misc.el")
    (load "misc"))

;;============Test stuff

(if (file-exists-p "~/.emacs.d/test.el")
    (load "test"))
